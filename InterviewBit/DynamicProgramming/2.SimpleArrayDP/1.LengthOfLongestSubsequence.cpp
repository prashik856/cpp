...
Solution Approach:
Important Question:
1. Learn how to calculate Longest Increasing Subsequence
2. Learn how to calculate Longest Decreasing Subsequence
3. Learn how to calculate Longest Bitonic Subsequence (Which is the required question.
We need to find a sequence which first increases and then decreases)
*/
#include<bits/stdc++.h>
using namespace std;
...
vector<int> getLDS(vector<int> &A) {
    vector<int> result(A.size(), 1);
...
int solve(vector<int> &A) {
    ...
    // cout << "Calculating LIS" << endl;
    vector<int> lis = getLIS(A);
    // cout << "LIS vector: " << endl;
    // printVector(lis);

    // cout << "Calculating lds: " << endl;
    vector<int> lds = getLDS(A);
    // cout << "LDS vector: " << endl;
    // printVector(lds);
...
int main(){
    vector<int> a = {9, 6, 1, 10, 2, 5, 12, 30, 31, 20, 22, 18};
