...
/*
Solution approach:
We use our Zeckendorfs theorem. We only need to find the max lenght of fibonacci series.
In our theorem, we find the max value in fibo series whose value is less than n.
That's it. return the count.
*/
#include<bits/stdc++.h>
using namespace std;
...
// This is a better way to create fibo
int getFibo(int n){
    int i = 1;
    int j = 1;
